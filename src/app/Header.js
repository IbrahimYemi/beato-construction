...
export default function Header() {
  ...
  return (
    <header>
      <nav className="bg-gray-900 border-gray-200 px-4 lg:px-6 pt-4">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <a href="/" className="flex items-center sm:hidden">
            <Image src="/logo.png" width={50} height={50} alt="Beato Logo" />
          ...
          <div className="flex items-center lg:order-2">
            ...
            <button
              onClick={toggleMenu}
              type="button"
              className="inline-flex items-center p-2 ml-1 text-sm text-gray-100 rounded-lg lg:hidden hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
